...
export let resumeExperienceStore = create((set) => ({
  ...
  addWorkDetailsArray: (expDetails) =>
    set((state) => ({
...
export let resumeEducationStore = create((set) => ({
  ...
  addEducationDetailsArray: (educationDetails) =>
    set((state) => ({
...
export let resumeDataStore = create((set) => ({
  ...
  updateResumePersonalInformation: (personalInformation) =>
    set((state) => ({
      resumeData: {
        ...state.resumeData,
        personalInformation: {
  ...
  updateResumeCertifications: (cert) =>
    set((state) => ({
      resumeData: {
        ...state.resumeData,
        certifications: [...cert],
  ...
  updateResumePortfolio: (portfolio) =>
    set((state) => ({
      resumeData: {
        ...state.resumeData,
        portfolio: [...portfolio],
  ...
  updateResumeWorkExp: (indexValue, exp) =>
    set((state) => ({
      resumeData: {
        ...state.resumeData,
  ...
  updateResumeWorkDetailsArray: (indexValue, expDetails) =>
    set((state) => ({
      resumeData: {
        ...state.resumeData,
        ...(state.resumeData.workExperiences[indexValue].description = [
          ...expDetails,
        ]),
      },
    })),
  ...
  updateResumeEducation: (indexValue, education) =>
    set((state) => ({
      resumeData: {
        ...state.resumeData,
  ...
  updateResumeEducationDetailsArray: (indexValue, educationDetails) =>
    set((state) => ({
      resumeData: {
        ...state.resumeData,
        ...(state.resumeData.educationalBackground[indexValue].description = [
          ...educationDetails,
        ]),
      },
    })),
  ...
  deleteResumeEducation: (indexValue) =>
    set((state) => ({
      resumeData: {
        ...state.resumeData,
        educationalBackground: state.resumeData.educationalBackground.filter(
          (_, i) => i !== indexValue
        ),
      },
    })),
...
export let resumeDataExperienceIndexStore = create((set) => ({
  indexValue: 0,
  resetIndexValue: (value) =>
    set((state) => ({
      indexValue: 0,
    })),
  incrementIndexValue: () =>
    set((state) => ({ indexValue: state.indexValue + 1 })),
  decrementIndexValue: () =>
    set((state) => ({ indexValue: state.indexValue - 1 })),
}));
