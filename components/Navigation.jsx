    ...
    return (
        <main className={`text-gray-900 fixed w-full transition-colors ease-in-out duration-300 min-h-20 z-50 
            ...
            <nav className="">
                ...
                <ul className={`px-10 py-5 ${scrollPosition > 900 ? 'md:w-full duration-300 ease-in-out' : 'md:w-1/2 duration-300 ease-in-out'} md:flex md:items-end md:justify-between xl:px-24 ${ open ? "block mt-10 md:mt-0" : "hidden"}`}>
