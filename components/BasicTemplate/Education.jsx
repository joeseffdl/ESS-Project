...
function Education({ educationProps }) {
  ...
  return (
    <>
      ...
      (educationField.institutionName || educationField.degreeType !== "") &&
      !router.query.id ? (
        <section className="w-full px-5">
          <div className="text-center font-bold my-1">Education</div>
          <div>
                        ...
                        >
                          ...
                          {education.description ? (
                            <div
                              style={{
                                paddingLeft:
                                  educationDescriptionPaddingL + "rem",
                              ...
                              {education.description?.map((detail) => {
                                return (
                                  <ul
                                    ...
                                    style={{
                                      paddingTop:
                                        educationDescriptionPaddingY + "rem",
                                      paddingBottom:
                                        educationDescriptionPaddingY + "rem",
                                    }}
                                    key={detail}
            ...
            <>
              {router.query.id ? (
                <>
                  ...
                  !addingDetailsValue &&
                  (resumeData.educationalBackground[0].institutionName != "" ||
                    resumeData.educationalBackground[0].degreeType != "") ? (
                    <section className="w-full px-5">
                      <div className="text-center font-bold my-1">
                        Educational Background
                      </div>
