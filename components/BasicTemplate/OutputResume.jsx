...
function OutputResume({ resumeDataProps, resumeProperties }) {
    const {
        ...
        summaryMarginX = '', summaryMarginY = '', summaryLineHeight = '',
        skillsPaddingL = '', skillsPaddingR = '', skillsPaddingT = '', skillsPaddingB = '',
        experiencesHeadMarginT = '', experiencesHeadMarginB = '', experiencesHeadPaddingX = '', experiencesDescriptionPaddingL = '', experiencesDescriptionPaddingR = '', experiencesDescriptionPaddingY = '', experiencesMarginB = '',
        educationHeadMarginT = '', educationHeadMarginB = '', educationSubHeadMarginT = '', educationSubHeadMarginB = '', educationHeadPaddingX = '', educationDescriptionPaddingL = '', educationDescriptionPaddingR = '', educationDescriptionPaddingY = '', educationMarginB = '',
        certificationsPaddingL = '', certificationsPaddingR = '', certificationsPaddingT = '', certificationsPaddingB = '',
        portfolioPaddingL = '', portfolioPaddingR = '', portfolioPaddingT = '', portfolioPaddingB = ''
    } = resumeProperties || {};
    ...
    const {
        ...
        educationalBackground: viewEducationalBackground = "viewEducationalBackground",
