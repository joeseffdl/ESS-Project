                ...
                : (
                    <section className="w-full ">
                        <div className="text-center text-3xl font-semibold my-4 tracking-widest">
                            {router.query.id ? (
                                `${resumeData.personalInformation.firstname?.toUpperCase() ?? "Fetching"} ${resumeData.personalInformation.surname?.toUpperCase() ?? "data"}`
                            ) : (
                                    ...
                                    <>
                                        ...
                                        {(resumeData.personalInformation.city || resumeData.personalInformation.country) && (
                                            <div className="px-2">
                                                ...
                                                {resumeData.personalInformation.city && ","} {resumeData.personalInformation.country} {resumeData.personalInformation.postalCode}
                                            </div>
                                        )}
                                    </>
                                )
                                    ...
                                    <>
                                        ...
                                        {(personalInformation.city || personalInformation.country) && (
                                            <div className="px-2">
                                                ...
                                                {personalInformation.city && ","} {personalInformation.country} {personalInformation.postalCode}
                                            </div>
                                        )}
                                    </>
                                )}
