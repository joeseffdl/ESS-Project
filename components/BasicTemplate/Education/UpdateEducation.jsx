...
function UpdateEducation() {
    ...
    return (
        <>
            {isUpdating
                ? <>
                    {(resumeData.educationalBackground.length > 0 && !addingDetailsValue) &&
                        (resumeData.educationalBackground[0].institutionName.length > 0 || resumeData.educationalBackground[0].degreeType.length > 0
                    )
