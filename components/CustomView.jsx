...
function CustomView({ resumeFormat, setResumeFormat }) {
  ...
  // Resume Properties
  const resumeTemplatesArray = ["Resume"];
    ...
    if (propertiesPage == 1) {
      return (
        <div className="w-full flex flex-col gap-2 px-5 mb-5">
          <label className="label justify-center text-sm font-semibold">
            Document Formatting
          </label>
          <select
          ...
          <div className="w-full flex items-center p-4 bg-white rounded-lg">
            <label className="w-full relative flex items-center justify-between text-xs font-semibold">
              Font Size:
              <input
          ...
          <div className="w-full flex items-center p-4 bg-white rounded-lg">
            <label className="w-full relative flex items-center justify-between text-xs font-semibold">
              ...
              <input
                ...
                max="3"
                step={
                  resumeFormat.headerFontSize >= 1.25 &&
                  resumeFormat.headerFontSize < 1.5
                    ? 0.25
                    : resumeFormat.headerFontSize >= 1.5 &&
          ...
          <div className="w-full flex items-center p-4 bg-white rounded-lg">
            <label className="w-full relative flex items-center justify-between text-xs font-semibold">
              ...
              <input
                ...
                max="3"
                step={
                  resumeFormat.headerLineHeight >= 1.25 &&
                  resumeFormat.headerLineHeight < 1.5
                    ? 0.25
                    : resumeFormat.headerLineHeight >= 1.5 &&
                      resumeFormat.headerLineHeight < 2.25
                    ? 0.375
          ...
          <div className="w-full flex items-center p-4 bg-white rounded-lg">
            <label className="w-full relative flex items-center justify-between text-xs font-semibold">
              ...
              <input
                ...
                max="24"
                step={
                  resumeFormat.summaryMarginX >= 1 &&
                  resumeFormat.summaryMarginX < 3
                    ? 0.25
                    : resumeFormat.summaryMarginX >= 3 &&
                      resumeFormat.summaryMarginX < 4
                    ? 0.5
                    : resumeFormat.summaryMarginX >= 4 &&
                      resumeFormat.summaryMarginX < 16
                    ? 1
                    : resumeFormat.summaryMarginX >= 16 &&
                      resumeFormat.summaryMarginX < 20
                    ? 2
                    : resumeFormat.summaryMarginX >= 20 &&
                      resumeFormat.summaryMarginX <= 24
                    ? 4
                    : 0.125
                }
                onChange={handleChange}
          ...
          <div className="w-full flex items-center p-4 bg-white rounded-lg">
            <label className="w-full relative flex items-center justify-between text-xs font-semibold">
              ...
              <input
                ...
                max="24"
                step={
                  resumeFormat.skillsPaddingL >= 1 &&
                  resumeFormat.skillsPaddingL < 3
                    ? 0.25
                    : resumeFormat.skillsPaddingL >= 3 &&
                      resumeFormat.skillsPaddingL < 4
                    ? 0.5
                    : resumeFormat.skillsPaddingL >= 4 &&
                      resumeFormat.skillsPaddingL < 16
                    ? 1
                    : resumeFormat.skillsPaddingL >= 16 &&
                      resumeFormat.skillsPaddingL < 20
                    ? 2
                    : resumeFormat.skillsPaddingL >= 20 &&
                      resumeFormat.skillsPaddingL <= 24
                    ? 4
                    : 0.125
                }
                onChange={handleChange}
          ...
          <div className="w-full flex items-center p-4 bg-white rounded-lg">
            <label className="w-full relative flex items-center justify-between text-xs font-semibold">
              ...
              <input
                ...
                max="24"
                step={
                  resumeFormat.skillsPaddingR >= 1 &&
                  resumeFormat.skillsPaddingR < 3
                    ? 0.25
                    : resumeFormat.skillsPaddingR >= 3 &&
                      resumeFormat.skillsPaddingR < 4
                    ? 0.5
                    : resumeFormat.skillsPaddingR >= 4 &&
                      resumeFormat.skillsPaddingR < 16
                    ? 1
                    : resumeFormat.skillsPaddingR >= 16 &&
                      resumeFormat.skillsPaddingR < 20
                    ? 2
                    : resumeFormat.skillsPaddingR >= 20 &&
                      resumeFormat.skillsPaddingR <= 24
                    ? 4
                    : 0.125
                }
                onChange={handleChange}
          ...
          <div className="w-full flex items-center p-4 bg-white rounded-lg">
            <label className="w-full relative flex items-center justify-between text-xs font-semibold">
              ...
              <input
                ...
                max="40"
                step={
                  resumeFormat.experiencesDescriptionPaddingL >= 1 &&
                  resumeFormat.experiencesDescriptionPaddingL < 3
                    ? 0.25
                    : resumeFormat.experiencesDescriptionPaddingL >= 3 &&
                      resumeFormat.experiencesDescriptionPaddingL < 4
                    ? 0.5
                    : resumeFormat.experiencesDescriptionPaddingL >= 4 &&
                      resumeFormat.experiencesDescriptionPaddingL < 16
                    ? 1
                    : resumeFormat.experiencesDescriptionPaddingL >= 16 &&
                      resumeFormat.experiencesDescriptionPaddingL < 20
                    ? 2
                    : resumeFormat.experiencesDescriptionPaddingL >= 20 &&
                      resumeFormat.experiencesDescriptionPaddingL >= 24
                    ? 4
                    : 0.125
                }
                onChange={handleChange}
          ...
          <div className="w-full flex items-center p-4 bg-white rounded-lg">
            <label className="w-full relative flex items-center justify-between text-xs font-semibold">
              ...
              <input
                ...
                max="40"
                step={
                  resumeFormat.educationDescriptionPaddingL >= 1 &&
                  resumeFormat.educationDescriptionPaddingL < 3
                    ? 0.25
                    : resumeFormat.educationDescriptionPaddingL >= 3 &&
                      resumeFormat.educationDescriptionPaddingL < 4
                    ? 0.5
                    : resumeFormat.educationDescriptionPaddingL >= 4 &&
                      resumeFormat.educationDescriptionPaddingL < 16
                    ? 1
                    : resumeFormat.educationDescriptionPaddingL >= 16 &&
                      resumeFormat.educationDescriptionPaddingL < 20
                    ? 2
                    : resumeFormat.educationDescriptionPaddingL >= 20 &&
                      resumeFormat.educationDescriptionPaddingL >= 24
                    ? 4
                    : 0.125
                }
                onChange={handleChange}
          ...
          <div className="w-full flex items-center p-4 bg-white rounded-lg">
            <label className="w-full relative flex items-center justify-between text-xs font-semibold">
              ...
              <input
                ...
                max="24"
                step={
                  resumeFormat.certificationsPaddingL >= 1 &&
                  resumeFormat.certificationsPaddingL < 3
                    ? 0.25
                    : resumeFormat.certificationsPaddingL >= 3 &&
                      resumeFormat.certificationsPaddingL < 4
                    ? 0.5
                    : resumeFormat.certificationsPaddingL >= 4 &&
                      resumeFormat.certificationsPaddingL < 16
                    ? 1
                    : resumeFormat.certificationsPaddingL >= 16 &&
                      resumeFormat.certificationsPaddingL < 20
                    ? 2
                    : resumeFormat.certificationsPaddingL >= 20 &&
                      resumeFormat.certificationsPaddingL <= 24
                    ? 4
                    : 0.125
                }
                onChange={handleChange}
          ...
          <div className="w-full flex items-center p-4 bg-white rounded-lg">
            <label className="w-full relative flex items-center justify-between text-xs font-semibold">
              ...
              <input
                ...
                max="24"
                step={
                  resumeFormat.certificationsPaddingR >= 1 &&
                  resumeFormat.certificationsPaddingR < 3
                    ? 0.25
                    : resumeFormat.certificationsPaddingR >= 3 &&
                      resumeFormat.certificationsPaddingR < 4
                    ? 0.5
                    : resumeFormat.certificationsPaddingR >= 4 &&
                      resumeFormat.certificationsPaddingR < 16
                    ? 1
                    : resumeFormat.certificationsPaddingR >= 16 &&
                      resumeFormat.certificationsPaddingR < 20
                    ? 2
                    : resumeFormat.certificationsPaddingR >= 20 &&
                      resumeFormat.certificationsPaddingR <= 24
                    ? 4
                    : 0.125
                }
                onChange={handleChange}
          ...
          <div className="w-full flex items-center p-4 bg-white rounded-lg">
            <label className="w-full relative flex items-center justify-between text-xs font-semibold">
              ...
              <input
                ...
                max="24"
                step={
                  resumeFormat.portfolioPaddingL >= 1 &&
                  resumeFormat.portfolioPaddingL < 3
                    ? 0.25
                    : resumeFormat.portfolioPaddingL >= 3 &&
                      resumeFormat.portfolioPaddingL < 4
                    ? 0.5
                    : resumeFormat.portfolioPaddingL >= 4 &&
                      resumeFormat.portfolioPaddingL < 16
                    ? 1
                    : resumeFormat.portfolioPaddingL >= 16 &&
                      resumeFormat.portfolioPaddingL < 20
                    ? 2
                    : resumeFormat.portfolioPaddingL >= 20 &&
                      resumeFormat.portfolioPaddingL <= 24
                    ? 4
                    : 0.125
                }
                onChange={handleChange}
          ...
          <div className="w-full flex items-center p-4 bg-white rounded-lg">
            <label className="w-full relative flex items-center justify-between text-xs font-semibold">
              ...
              <input
                ...
                max="24"
                step={
                  resumeFormat.portfolioPaddingR >= 1 &&
                  resumeFormat.portfolioPaddingR < 3
                    ? 0.25
                    : resumeFormat.portfolioPaddingR >= 3 &&
                      resumeFormat.portfolioPaddingR < 4
                    ? 0.5
                    : resumeFormat.portfolioPaddingR >= 4 &&
                      resumeFormat.portfolioPaddingR < 16
                    ? 1
                    : resumeFormat.portfolioPaddingR >= 16 &&
                      resumeFormat.portfolioPaddingR < 20
                    ? 2
                    : resumeFormat.portfolioPaddingR >= 20 &&
                      resumeFormat.portfolioPaddingR <= 24
                    ? 4
                    : 0.125
                }
                onChange={handleChange}
      ...
      <div className="w-full h-full flex flex-col justify-center bg-primary-focus/50 rounded text-black">
        ...
        <div className="h-full flex items-end justify-around drop-shadow-2xl pb-6">
          <button
            ...
            className="btn btn-secondary border-2 border-white text-white font-bold hover:text-accent hover:border-accent"
            onClick={previousPage}
          >
            &#60;
          </button>
          <button
            disabled={propertiesPage == 3}
            className="btn btn-secondary border-2 border-white text-white font-bold hover:text-accent hover:border-accent"
            onClick={nextPage}
          >
            &#62;
